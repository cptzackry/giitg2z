                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $courseAuthor; ?></td>
                            <td><?php echo $courseDuration; ?></td>
                            <td>
                                
                                <a href="editcourse.php?id=<?php echo $courseId; ?>" class="btn btn-primary">Edit</a>
                                <a href="?delete_course=<?php echo $courseId; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this course?')">Delete</a>
                        ...
                        <?php
                            ...
                            echo '<tr><td colspan="6">Sorry, there are no available courses right now.</td></tr>';
                        }
                        ?>
                    </tbody>
                </table>
