...
<body>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="lesson">
                                ...
                                // Check if there are any lessons for this course
                                if ($lessonResult && $lessonResult->num_rows > 0) {
                                    // Loop through the lessons for the current course and display them
                                ...
                                <?php
                                    ...
                                    // Display a message if there are no lessons for this course
    ...
    $(document).ready(function() {
        $(".enroll-button").click(function() {
            ...
            // Debugging statement - Check if the button click event is working
